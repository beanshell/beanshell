...
BeanShell 3 builds a headless `bsh` core (including JSR-223) and separate GUI and BSF bundles. See [module selection and migration](docs/MODULES.md), including optional OSGi Service Loader mediation.
