...
-- Versions and Building the Source --
...
The file XThis.java is a module loaded only when bsh is run under JDK1.3
or greater.  It makes use of new features of the reflection API and will not 
