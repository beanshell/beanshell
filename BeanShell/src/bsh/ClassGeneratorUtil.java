...
public class ClassGeneratorUtil implements Constants 
{
	...
	*/
	...
	) 
	{
		...
		installConstructorsList(
			className, classStaticNameSpace, bshmethods );
	}

	private void installConstructorsList(
		String className, NameSpace classStaticNameSpace,
