...
/**
 * The Class ClassGeneratorTest.
 */
@RunWith(FilteredTestRunner.class)
public class ClassGeneratorTest {

    /**
     * Creates the class with default constructor.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void outer_namespace_visibility() throws Exception {
        final Callable callable = (Callable) TestUtil.eval(
                ...
                "public Object call() { return var; }", "}", "var = 0;",
                "a = new X4();", "var = 1;", "return a;");
    ...
    public void static_fields_should_be_frozen() throws Exception {
        final Callable callable = (Callable) TestUtil.eval("var = 0;",
                "class X5 implements java.util.concurrent.Callable {",
                "static final Object VAR = var;",
                "public Object call() { return VAR; }", "}", "a = new X5();",
                "var = 1;", "return a;");
     ...
     * <a href="http://code.google.com/p/beanshell2/issues/detail?id=46">issue
     * #46</a>.
     *
     * @throws Exception
     *             the exception
