 ...
 *                                                                           *
 *****************************************************************************/
/* Copied from the Token that JavaCC 8.1.0 generates; the build skips generating it while
 * this file exists. It differs only in being Serializable with the serialVersionUID that
 * BeanShell tokens have always had, so objects saved by earlier builds still load. To refresh
 * after a JavaCC upgrade: delete this file, build, copy the generated file back here and
...
public class Token implements java.io.Serializable {
   ...
   *  specialToken field, and so on until the first special token (whose specialToken field is null).<br>
...
/* JavaCC - OriginalChecksum=aeff3b0a3347623e6c5e76c83c315834 (do not edit this line) */
