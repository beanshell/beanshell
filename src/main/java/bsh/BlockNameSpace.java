...
class BlockNameSpace extends NameSpace {
    ...
    /**
     * Instantiates a new block name space.
     *
     * @param parent
     *            the parent
     * @throws EvalError
     *             the eval error
     */
    public BlockNameSpace(final NameSpace parent) throws EvalError {
     ...
     */
    @Override
    public Variable setVariable(final String name, final Object value,
        ...
        if (this.weHaveVar(name))
            ...
            return this.getParent().setVariable(name, value, strictJava,
                    recurse);
    }
     ...
     *             the util eval error
     */
    public void setBlockVariable(final String name, final Object value)
            throws UtilEvalError {
     ...
     */
    private boolean weHaveVar(final String name) {
    ...
    /**
     * Gets the non block parent.
     *
     * @return the non block parent
     */
    private NameSpace getNonBlockParent() {
        final NameSpace parent = super.getParent();
        if (parent instanceof BlockNameSpace)
