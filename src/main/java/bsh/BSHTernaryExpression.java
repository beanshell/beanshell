...
class BSHTernaryExpression extends SimpleNode {
    ...
    /**
     * Instantiates a new BSH ternary expression.
     *
     * @param id
     *            the id
     */
    BSHTernaryExpression(final int id) {
        super(id);
    }
    ...
    public Object eval(final CallStack callstack, final Interpreter interpreter)
            throws EvalError {
        final SimpleNode cond = (SimpleNode) this.jjtGetChild(0),
                evalTrue = (SimpleNode) this.jjtGetChild(1),
                evalFalse = (SimpleNode) this.jjtGetChild(2);
