...
public class This implements java.io.Serializable, Runnable {
     ...
     * @return the this
     */
    static This getThis(final NameSpace namespace,
            final Interpreter declaringInterpreter) {
        try {
            Class c;
     ...
     */
    public Object getInterface(final Class clas) throws UtilEvalError {
     ...
     *             the util eval error
     */
    public Object getInterface(final Class[] ca) throws UtilEvalError {
     ...
     * children.
     */
    protected This(final NameSpace namespace,
            final Interpreter declaringInterpreter) {
    ...
    public Object invokeMethod(final String name, final Object[] args)
        ...
        return this.invokeMethod(name, args, null/* declaringInterpreter */,
                null, null, false/* declaredOnly */);
    }
    ...
    public Object invokeMethod(final String methodName, Object[] args,
            ...
            final boolean declaredOnly) throws EvalError {
        /*
         * Wrap nulls.
        ...
        try {
            bshMethod = this.namespace.getMethod(methodName, types,
                    declaredOnly);
        ...
        // is that ok?
        try {
            bshMethod = this.namespace.getMethod("invoke",
                    new Class[] {null, null});
        ...
        throw new EvalError(
                "Method " + StringUtil.methodString(methodName, types)
     ...
     *            the declaring interpreter
     */
    public static void bind(final This ths, final NameSpace namespace,
            final Interpreter declaringInterpreter) {
     ...
     * @param name
     *            the name
     * @return true, if is exposed this method
     */
    static boolean isExposedThisMethod(final String name) {
        return name.equals("getClass") || name.equals("invokeMethod")
                || name.equals("getInterface")
                // These are necessary to let us test synchronization from
                // scripts
