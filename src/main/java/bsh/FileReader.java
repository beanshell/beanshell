...
final public class FileReader extends InputStreamReader {
    ...
    /** Creates a new <code>FileReader</code>, given the name of the
     * file to read from.
    ...
    /** Creates a new <code>FileReader</code>, given the
     * <code>FileDescriptor</code> to read from.
     * @param fd the FileDescriptor to read from */
    public FileReader(FileDescriptor fd) {
        this(new FileInputStream(fd));
    }

    /** Creates a new <code>FileReader</code> that uses UTF-8 charset.
